...
<?php $sql = $conn->display_member_edit($_GET['id']);
...
<div class="container">
 ...
 <button
  type="submit" class="btn btn-primary" id="edit" name="edit">บันทึกการเปลี่ยนแปลง </button>
 </form>
 </div>
...
if(isset($_POST['edit'])){
    ...
    echo $sql;
    if($sql){
        echo "<script>alert('บันทึกข้อมลู สำเร็จ')</script>";
